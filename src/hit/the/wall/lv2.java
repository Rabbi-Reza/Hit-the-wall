...
public class lv2 extends JFrame implements Runnable {
           ...
           Rectangle r4 = new Rectangle(0,25,625,25);
            ...
            //wall property
              ...
              //End
                ...
                //shift property
                if(r1.intersects(r22)){
                    
                    new lv2().setVisible(false);
                                      this.dispose();
        
                                  lv2b1 = new lv2b1();
                                  lv2b1.setVisible(true);
                                  Thread s1 = new Thread(lv2b1);
                                  s1.start();
                ...
                //Collition
                 if(r1.intersects(r31)||r1.intersects(r30)||r1.intersects(r21)||r1.intersects(r29)|| r1.intersects(r24) || r1.intersects(r4) || r1.intersects(r5)|| r1.intersects(r6)|| r1.intersects(r7)|| r1.intersects(r8)|| r1.intersects(r9)|| r1.intersects(r10)|| r1.intersects(r11)|| r1.intersects(r12)|| r1.intersects(r13)|| r1.intersects(r14)|| r1.intersects(r15) || r1.intersects(r16)|| r1.intersects(r17)|| r1.intersects(r18)|| r1.intersects(r19)|| r1.intersects(r20)|| r1.intersects(r25) || r1.intersects(r26)|| r1.intersects(r27)|| r1.intersects(r28) ) {
