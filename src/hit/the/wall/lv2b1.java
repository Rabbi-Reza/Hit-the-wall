...
public class lv2b1 extends JFrame implements Runnable {
        ...
        private Image dbImage;
         ...
         int rectX , rectY, life, flag ,hit,pass;
           ...
           int size;
            ...
            int Ans,ran1,ran2,ran3,ran4,ran5;
    ...
    public class AL extends KeyAdapter{
        ...
        public void keyReleased(KeyEvent e){
           ...
           public lv2b1 ()  {
              ...
              ran1 = randomGenerator1.nextInt(50);
              ran2 = randomGenerator2.nextInt(50);
              ran3 = randomGenerator3.nextInt(1);
              ran4 = randomGenerator3.nextInt(1);
              ran5 = randomGenerator3.nextInt(7);
                ran5 = ran5 + 1;
                         //Load Images
         ...
         Rectangle r2 = new Rectangle(0,530,70,45);
          ...
          Rectangle r4 = new Rectangle(0,25,625,25);
            Rectangle r5 = new Rectangle(450,25,300,50);
             Rectangle r6 = new Rectangle(0,120, 350,40);
              Rectangle r7 = new Rectangle(300,150,100,140);
                          ...
                          Rectangle r19 = new Rectangle(0,75,15,575); 
                            Rectangle r20 = new Rectangle(685,0,15,700);
                             Rectangle r24 = new Rectangle(602,153,27,82);
                              ...
                              Rectangle r31= new Rectangle(0,233,627 ,18);
                              //new walls
                                 ...
                                 Rectangle r27 = new Rectangle(540,320,45,30);
                                  Rectangle r28 = new Rectangle(670,260,27,45);
                                   Rectangle r29 = new Rectangle(620,300,27,25);
                                    ...
                                    Rectangle r35 = new Rectangle(133,382,133,5);
                                    Rectangle r38 = new Rectangle(130,325,5,62);
                                    Rectangle r36 = new Rectangle(263,325,5,62);   
                                    Rectangle r37 = new Rectangle(133,325,133,5);   
                                       
                             //shifts
                               Rectangle r22= new Rectangle(525,200,30,30);
                                Rectangle r23= new Rectangle( 400 ,377,25,28);
                             
              // Ans point         
             Rectangle r33 = new Rectangle(90,160,33,33);
             Rectangle r32 = new Rectangle(193,160,33,33); 
             //Ques box                       
             Rectangle r34 = new Rectangle(133,330,133,53);        
                                  
                      
               //inside start
       g.setColor(Color.blue);            
       g.fillOval(143, 470, 50, 50);
            ...
            //wall property
                ...
                g.fillRect(r4.x, r4.y, r4.width, r4.height);
                 g.fillRect(r4.x-10 , r4.y+550, r4.width + 100, r4.height);
                                       ...
                                       g.fillRect(r27.x, r27.y, r27.width, r27.height);
                                        g.fillRect(r28.x, r28.y, r28.width, r28.height);
                                         g.fillRect(r29.x, r29.y, r29.width, r29.height);
                                           ...
                                           g.fillRect(r35.x, r35.y, r35.width, r35.height);
                                           g.fillRect(r38.x, r38.y, r38.width, r38.height);
                                           g.fillRect(r36.x, r36.y, r36.width, r36.height);
                                           g.fillRect(r37.x, r37.y, r37.width, r37.height);
                        // shift
  ...
  g.fillRect(r33.x, r33.y, r33.width, r33.height);
  g.fillRect(r32.x, r32.y, r32.width, r32.height); 
                ...
                if(r1.intersects(r3)){
                  ...
                  g.setColor(Color.white);
                     g.setFont(font);
                 if(ran3==1){
                     g.drawString(""+Ans , ans, 145);
                    
                 Ans = Ans + ran5; 
                  g.drawString(""+Ans, ans1, 145);
          }
            if(ran3==0){
                 g.drawString(""+Ans, ans1, 145);
                ...
                g.drawString(" Level 2 ", 373, 130);
                   ...
                   if( r1.intersects(r35) || r1.intersects(r36)|| r1.intersects(r37) || r1.intersects(r38) ) {
                       if(life == 1 || life == 3 || life == 2 ){
                         hit = 1 ;
                     }
           ...
           //Collition
                 if(r1.intersects(r21)||r1.intersects(r29)|| r1.intersects(r24) || r1.intersects(r4) || r1.intersects(r5)|| r1.intersects(r6)|| r1.intersects(r7)|| r1.intersects(r8)|| r1.intersects(r8)|| r1.intersects(r10)|| r1.intersects(r11)|| r1.intersects(r12)|| r1.intersects(r13)|| r1.intersects(r14)|| r1.intersects(r15) || r1.intersects(r16)|| r1.intersects(r17)|| r1.intersects(r18)|| r1.intersects(r19)|| r1.intersects(r20)|| r1.intersects(r25) || r1.intersects(r26)|| r1.intersects(r27)|| r1.intersects(r28) ) {
                 ...
                 //Question
           g.setColor(Color.black);
           g.fillRect(r34.x , r34.y, r34.width, r34.height);
           g.setColor(Color.white);
            g.setFont(font3);
                   g.drawString(" "+ran1 + " + " + ran2 +" = ?" , 157, 359);    
                 //Level passed
                 if(r1.intersects(r33)){
                     
                       //Next level ( lv 2 )
                          new lv2b1().setVisible(false);
                                      this.dispose();
        
                                   lv2b2 = new lv2b2();
                                  lv2b2.setVisible(true);
                                  Thread s1 = new Thread(lv2b2);
                                       s1.start();
